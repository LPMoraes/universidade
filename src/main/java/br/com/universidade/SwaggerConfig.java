...
public class SwaggerConfig {
    ...
    public Docket detalheApi() {
        ...
        docket.select().apis(RequestHandlerSelectors.basePackage("br.com.universidade.endpoint"))
    ...
    private Contact contato() {
        ...
        return new Contact("Felipe Aragão", "localhost", "felipe.thiago10@gmail.com");
    }
}
